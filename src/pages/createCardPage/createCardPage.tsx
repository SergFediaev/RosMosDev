...
export const CreateCardPage = () => {
    ...
    const createCard: SubmitHandler<CreateCardForm> = data => console.log(data)
        ...
        <>
            ...
            <Page>
                <S.CreateCard>
                    ...
                    <Button name={TEXTS[lang].CLEAR} onClick={reset} align={VALUES.STRETCH} isSecondary isWarning />
                </S.CreateCard>
            </Page>
        </>
    )
